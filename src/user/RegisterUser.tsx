...
function RegisterUser({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className={`w-screen h-screen bg-trans flex justify-center items-center transition-all duration-1000 ease-in-out transform ${
      ...
      <form className="max-w-md mx-auto mx-auto shadow-md p-6 relative bg-white" onSubmit={handleSubmit}>
        ...
        <h4 className="text-center my-3 font-bold text-xl">Đăng ký tài khoản</h4>
        ...
        <div className="mb-5">
          <input
            type="text"
            id="noinhanhang"
            value={formData.noinhanhang}
            onChange={handleChange}
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Nơi nhận hàng"
            required
          />
        </div>
